...
const roles = [
  {
    ...
    tags: ["Work Orders", "RCA Assistant", "Failure History", "Spares"],
  },
  {
    icon: Factory,
    name: "Plant Operations",
    tags: ["Live SOPs", "Shift Reports", "Ops Alerts", "Trends"],
  },
  {
    icon: HardHat,
  ...
  },
  {
    icon: Building2,
    name: "Plant Manager",
    tags: ["Enterprise KPIs", "Approvals", "Exec AI Insights"],
  },
  {
    icon: FolderCog,
    name: "Document Controller",
    tags: ["Versioning", "Approvals", "Audit Trail"],
  },
  {
    icon: Cpu,
...
export function Roles() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #071A2E 0%, #0a2547 100%)",
      }}
    >
        ...
        <div className="flex items-end justify-between flex-wrap gap-6">
          <div className="max-w-xl">
            ...
            <h2 className="mt-3 font-display text-4xl md:text-5xl font-bold tracking-tight">
              ...
              <br />
              own{" "}
              <span className="text-gradient-cyan">intelligent workspace</span>.
            </h2>
          </div>
