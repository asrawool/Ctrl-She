...
function VerifyPage() {
  ...
  const { email, setOtpVerified, isExistingUser } = useAuth();
  ...
  return (
    <AuthShell
      ...
      subtitle={
        isExistingUser
          ? `Welcome back! Enter the code sent to ${email}`
          : `Welcome! Let's verify your email to get started. Code sent to ${email}`
      }
    >
      <div className="space-y-5">
        ...
        <Button
          onClick={verify}
          disabled={!complete || loading || success}
