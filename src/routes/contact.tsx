        ...
        <section className="mx-auto max-w-6xl px-6 grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h1 className="mt-3 font-display text-4xl md:text-5xl font-bold tracking-tight">
              Talk to our{" "}
              <span className="text-gradient-cyan">industrial AI</span>{" "}
              specialists.
            </h1>
            <p className="mt-4 text-muted-foreground">
              Deployment discovery, technical architecture review, security
              assessment — we come prepared.
            </p>
            <div className="mt-8 space-y-3 text-sm">
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-accent" /> contact@intelliplant.ai
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-4 w-4 text-accent" /> +91 22 6900 4400
              </div>
              <div className="flex items-center gap-3">
                <MapPin className="h-4 w-4 text-accent" /> Mumbai · Bengaluru ·
                Frankfurt · Houston
              </div>
            </div>
          </div>
          ...
          >
            {sent ? (
              ...
              <>
                ...
                <textarea
                  rows={5}
                  placeholder="Tell us about your plant environment and goals…"
                  required
